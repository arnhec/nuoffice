...
public class UserSession {
	...
	private boolean cobrowsing;
	
	public UserSession(WebSocketSession session, String name, boolean cobrowsing) {
		this(session, name);
		this.setCobrowsing(cobrowsing);
	}
	...
	public void setCobrowsing(boolean cobrowsing) {
